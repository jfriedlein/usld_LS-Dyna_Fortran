...
*           Co. J. Korelc  2020           22 May 24 11:25:14 *
**************************************************************
...
Total size of C code            : 12717 bytes */
#include "sms.h"

/******************* S U B R O U T I N E *********************/
void stabilisation_Q1LES(double X[8][3],double u[8][3],double (*bulkModkappa)
     ,double (*shearModmu),double (*HGscale),int (*istif),double forceHG[24]
     ,double stiffHG[24][24])
{
double v[734];
int i55,i191,i203,b188,b204,b205,b270;
v[348]=1e0;
v[349]=1e0;
v[350]=1e0;
v[351]=1e0;
...
v[355]=1e0;
v[356]=8e0;
v[339]=-0.5773502691896257e0;
v[340]=-0.5773502691896257e0;
v[341]=-0.5773502691896257e0;
v[342]=-0.5773502691896257e0;
v[343]=0.5773502691896257e0;
v[344]=0.5773502691896257e0;
v[345]=0.5773502691896257e0;
v[346]=0.5773502691896257e0;
v[347]=0e0;
v[330]=-0.5773502691896257e0;
v[331]=-0.5773502691896257e0;
v[332]=0.5773502691896257e0;
v[333]=0.5773502691896257e0;
v[334]=-0.5773502691896257e0;
v[335]=-0.5773502691896257e0;
v[336]=0.5773502691896257e0;
v[337]=0.5773502691896257e0;
v[338]=0e0;
v[321]=-0.5773502691896257e0;
v[322]=0.5773502691896257e0;
v[323]=0.5773502691896257e0;
v[324]=-0.5773502691896257e0;
v[325]=-0.5773502691896257e0;
v[326]=0.5773502691896257e0;
v[327]=0.5773502691896257e0;
v[328]=-0.5773502691896257e0;
v[329]=0e0;
v[1]=X[0][0];
v[2]=X[0][1];
v[3]=X[0][2];
...
v[50]=(*shearModmu);
v[227]=2e0*v[50];
v[51]=(*bulkModkappa)+(-2e0/3e0)*v[50];
v[52]=(*HGscale);
b204=(*istif)==1;
for(i55=1;i55<=9;i55++){
 v[56]=v[320+i55];
 ...
 v[175]=v[139]*v[25]+v[143]*v[28]+v[148]*v[31]+v[152]*v[34]+v[157]*v[37]+v[161]*v[40]+v[166]*v[43]
  +v[170]*v[46];
 v[198]=v[140]*v[25]+v[139]*v[26]+v[145]*v[28]+v[143]*v[29]+v[149]*v[31]+v[148]*v[32]+v[154]*v[34]
  +v[152]*v[35]+v[158]*v[37]+v[157]*v[38]+v[163]*v[40]+v[161]*v[41]+v[167]*v[43]+v[166]*v[44]
  +v[172]*v[46]+v[170]*v[47];
 v[179]=v[140]*v[26]+v[145]*v[29]+v[149]*v[32]+v[154]*v[35]+v[158]*v[38]+v[163]*v[41]+v[167]*v[44]
  +v[172]*v[47];
 v[199]=v[141]*v[25]+v[139]*v[27]+v[147]*v[28]+v[143]*v[30]+v[150]*v[31]+v[148]*v[33]+v[156]*v[34]
  +v[152]*v[36]+v[159]*v[37]+v[157]*v[39]+v[165]*v[40]+v[161]*v[42]+v[168]*v[43]+v[166]*v[45]
  +v[174]*v[46]+v[170]*v[48];
 v[200]=v[141]*v[26]+v[140]*v[27]+v[147]*v[29]+v[145]*v[30]+v[150]*v[32]+v[149]*v[33]+v[156]*v[35]
  +v[154]*v[36]+v[159]*v[38]+v[158]*v[39]+v[165]*v[41]+v[163]*v[42]+v[168]*v[44]+v[167]*v[45]
  +v[174]*v[47]+v[172]*v[48];
 ...
 v[183]=v[141]*v[27]+v[147]*v[30]+v[150]*v[33]+v[156]*v[36]+v[159]*v[39]+v[165]*v[42]+v[168]*v[45]
  +v[174]*v[48];
 ...
 for(i191=1;i191<=24;i191++){
  forceHG[i191-1]+=v[105]*(v[387+i191]+v[189]*v[435+i191]*v[50])*v[59];
  for(i203=1;i203<=24;i203++){
   if(b204){
   ...
   stiffHG[i191-1][i203-1]+=v[222]*v[59];
  };/* end for */
 };/* end for */
};/* end for */
};
