...
%*           Co. J. Korelc  2020           22 May 24 11:24:57 *
%**************************************************************
...
% Total size of Matlab code      : 12551 bytes 

%*********************** F U N C T I O N **************************
function[forceHG,stiffHG]=stabilisation_Q1LES(X,u,bulkModkappa,shearModmu,HGscale,istif);
persistent v;
if size(v)<734
  v=zeros(734,'double');
end;
...
for i55=1:1:9;
 ...
 v(198)=v(140)*v(25)+v(139)*v(26)+v(145)*v(28)+v(143)*v(29)+v(149)*v(31)+v(148)*v(32)+v(154)*v(34) ...
  +v(152)*v(35)+v(158)*v(37)+v(157)*v(38)+v(163)*v(40)+v(161)*v(41)+v(167)*v(43)+v(166)*v(44)+v(172 ...
  )*v(46)+v(170)*v(47);
 ...
 v(199)=v(141)*v(25)+v(139)*v(27)+v(147)*v(28)+v(143)*v(30)+v(150)*v(31)+v(148)*v(33)+v(156)*v(34) ...
  +v(152)*v(36)+v(159)*v(37)+v(157)*v(39)+v(165)*v(40)+v(161)*v(42)+v(168)*v(43)+v(166)*v(45)+v(174 ...
  )*v(46)+v(170)*v(48);
 v(200)=v(141)*v(26)+v(140)*v(27)+v(147)*v(29)+v(145)*v(30)+v(150)*v(32)+v(149)*v(33)+v(156)*v(35) ...
  +v(154)*v(36)+v(159)*v(38)+v(158)*v(39)+v(165)*v(41)+v(163)*v(42)+v(168)*v(44)+v(167)*v(45)+v(174 ...
  )*v(47)+v(172)*v(48);
 ...
 for i191=1:1:24;
  forceHG(i191)=forceHG(i191)+v(105)*v(59)*(v(387+i191)+v(189)*v(50)*v(435+i191));
  for i203=1:1:24;
   if(b204)
