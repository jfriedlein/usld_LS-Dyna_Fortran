...
%*           Co. J. Korelc  2020           13 Jun 24 12:57:36 *
%**************************************************************
...
% Total size of Matlab code      : 3532 bytes 

%*********************** F U N C T I O N **************************
function[forceHG,stiffHG]=stabilisation_Q1LES_2D(X,u,bulkModkappa,shearModmu,HGscale,istif);
persistent v;
if size(v)<343
  v=zeros(343,'double');
end;
...
for i23=1:1:5;
 ...
 v(83)=v(10)*v(52)+v(12)*v(55)+v(11)*v(57)+v(14)*v(59)+v(13)*v(61)+v(16)*v(64)+v(15)*v(67)+v(53)*v ...
  (9);
 v(197)=v(53)*v(83);
 v(198)=v(52)*v(83);
 v(199)=v(57)*v(83);
 ...
 for i77=1:1:8;
  forceHG(i77)=forceHG(i77)+v(26)*v(47)*(v(180+i77)+v(103)*v(196+i77));
  for i86=1:1:8;
   if(b87)
    v(91)=v(47)*v(211+i77);
    v(92)=v(47)*v(219+i77);
